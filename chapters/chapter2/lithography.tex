...
\begin{figure}[h]
    ...
    \caption{Overview of the photolithographic fabrication steps for the EG-FET device. The process starts with photoresist deposition, then it shows UV exposure through a patterned mask to define the device geometry, and subsequent development to remove the unexposed regions. In the end, an optical microscope image of the patterned interdigitated electrodes of the fabricated device.}
    \label{fig:litho}
\end{figure}
...
After cleaning, the substrate underwent a pre-baking step on a hotplate at \SI{115}{\celsius} for \SI{5}{\minute}, followed by \SI{5}{\minute} in a hexamethyldisilazane (HMDS) environment, whose vapour reacts with the surface, forming a hydrophobic layer and avoiding moisture formation; this step is supposed to favour photoresist adhesion to the substrate by preventing the interference of humidity \citep{pollentierBake2022}.

Photoresist was then deposited using a spin coater; the thickness and uniformity was controlled by appropriately adjusting the speed and time of rotation. Indeed, to reach optimal deposition, the spin coater was set to \SI{3000}{rpm}, with a spin acceleration of \SI{750}{rpm/s} and a total spin time of \SI{34}{\second}.
