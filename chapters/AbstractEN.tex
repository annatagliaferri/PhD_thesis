...
Foodborne illnesses are a phenomenon that affects approximately
\SI{10}{\percent} of the population, resulting in the death of \num{420000}
people. Strategies can be devised to prevent the onset and diffusion of
outbreaks; a promising solution includes sensors and biosensors, that are
advanced devices able to convert the interaction between a target analyte and a
recognition element into a detectable signal, whose form depends on the
transducer (optical, electrical, etc.). This project shows how electrolyte-gated
field-effect transistors (EG-FETs) can be integrated as the transducer in a
biosensor; the EG-FET is an innovative three-electrode platform that is
intrinsically able to amplify small electric field variations at the gate
electrode, leading to the generation of larger output current variations. The
EG-FET, not only leads to signal amplification, but it also requires the use of
an electrolyte as dielectric, thus allowing the biological molecules under
observation to remain in a quasi-native environment, preventing their
degradation. The electrolyte also directly contributes to signal amplification,
thanks to a high dielectric constant, which results in a high capacitance; a
higher capacitance causes a stronger modulation of the channel conductance for a
given gate voltage, thereby improving the sensitivity of the device. Another
important component of the EG-FET is the semiconductor, where the charges flow
to generate the response current of the platform. This project employs a random
network of semiconducting single-walled carbon nanotubes (SWCNTs), chosen for
their unique electronic, chemical and mechanical properties, such as high
mobility and flexibility. Despite having numerous advantages, SWCNTs are
susceptible to the presence of oxygen and water in the environment, which can
affect their conductivity and mobility, thus leading to instability and
compromising platform performance. This project demonstrates a simple,
inexpensive method to enhance EG-CNTFET stability and reliability: a lipophilic
membrane is dropcasted onto the channel, preventing SWCNT contamination; this
results in faster stabilization, occurring in 33 minutes, significantly less
than other advanced devices reported in the literature, which require double
that time. Furthermore, the devices were able to maintain stability when stored
in air, as opposed to previous devices that needed a protective nitrogen-filled
environment, and they were resistant to electric stress for up to 12 hours.
Additional testing proved that these devices could also withstand five
repetitive rounds of experiments with very little variability among the
different cycles. 

A thorough comprehension of the working mechanism of the membrane was still
lacking, consequently COMSOL simulations were conducted, yielding preliminary
results; however, further work is required for complete device characterization
and conclusive findings. 

Once the platform was stable, it was tested as the transducer for ammonium and
histamine sensors. The ammonium sensor, functionalized with an ion-sensitive
membrane on the gate, detected ammonium ions linearly from \SI{0.01}{mM} to
\SI{100}{mM}. The histamine sensor, functionalized with aptamers on the gate,
indicates detection capabilities down to \SI{0.01}{\micro M} of histamine.
