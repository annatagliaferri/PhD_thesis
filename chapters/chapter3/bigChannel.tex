...
%In Figure \ref{fig:avgVth}, we observe the average \vth{} for devices without a membrane and devices with the membrane in red and blue, respectively. From this plot we can clearly see that this parameter keeps increasing in modulus for membrane-less devices, meaning that more energy is needed to turn on the device, leading to increased energy expenditure [is this correct? How would you explain it better? does the vth have any other meaning?].}
